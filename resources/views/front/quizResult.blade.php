...
<div class="card-header mb-2 py-3">
    ...
    <p class ="date text-blue text-center" >Vous trouverez ci-dessous les réponses que vous avez apportées à notre sondage le "{{$answers[0]->created_at->isoFormat('DD.mm.YYYY à HH.mm')}}"</p>
</div>        
